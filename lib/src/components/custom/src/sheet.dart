...
class _SlidingSheetState extends State<SlidingSheet>
  ...
  double get borderHeight => widget.border.top.width * 2;
  EdgeInsets? get padding {
    final begin = widget.padding;
...
class SheetState {
  ...
  SheetState(
    ...
    // Thus we have to account for this and set the minExtent to be zero.
        ...
        isAtTop = _extent!.isAtTop,
        isAtBottom = _extent.isAtBottom,
        isHidden = extent <= 0.0,
        isShown = extent > 0.0,
        scrollOffset = _extent.scrollOffset;
  ...
  double get currentScrollOffset => _extent!.scrollOffset;

  /// The maximum amount the Scrollable inside the sheet can scroll.
  double get maxScrollExtent => _extent!.maxScrollExtent;
