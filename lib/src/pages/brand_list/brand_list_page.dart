    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            CachedNetworkImage(
              key: ValueKey(_homeChangeNotifier.sortedBrandList[index].brandImage ?? ''),
              cacheKey: _homeChangeNotifier.sortedBrandList[index].brandImage ?? '',
              imageUrl: _homeChangeNotifier.sortedBrandList[index].brandImage ?? '',
              errorWidget: (context, url, error) => Icon(Icons.error),
              progressIndicatorBuilder: (_, __, ___) {
                return CachedNetworkImage(
                  key: ValueKey(_homeChangeNotifier.sortedBrandList[index].brandThumbnail ?? ''),
                  cacheKey: _homeChangeNotifier.sortedBrandList[index].brandThumbnail ?? '',
