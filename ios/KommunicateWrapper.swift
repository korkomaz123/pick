...
@objc public class KommunicateWrapper: NSObject { 
    ...
    @objc func useCustomConfigurations() {
        ...
        KMMessageStyle.sentBubble.color = UIColor(red:0.35, green:0.274, blue:0.691, alpha:1.0)
        // kmNavigationBarProxy.barTintColor = UIColor(red:0.35, green:0.274, blue:0.691, alpha:1.0)
